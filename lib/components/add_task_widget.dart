...
class _AddTaskWidgetState extends State<AddTaskWidget> {
  ...
  void initState() {
    ...
    _model.details2TextController ??= TextEditingController();
    _model.details2FocusNode ??= FocusNode();
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              width: double.infinity,
              child: TextFormField(
                controller: _model.details2TextController,
                focusNode: _model.details2FocusNode,
                autofocus: false,
                obscureText: false,
                decoration: InputDecoration(
                  isDense: true,
                ...
                cursorColor: FlutterFlowTheme.of(context).primaryText,
                validator:
                    _model.details2TextControllerValidator.asValidator(context),
              ),
            ),
            FFButtonWidget(
              onPressed: () async {
                await TasksRecord.collection.doc().set(createTasksRecordData(
                      ...
                      details: _model.details2TextController.text,
                      isCompleted: false,
